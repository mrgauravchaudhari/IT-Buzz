                                    ...
                                    <div className="col-lg-6 col-md-6">
                                        <div className="software-innovation-hero-wrap wow move-up">
                                            <div className="software-innovation-hero-text">
                                                ...
                                                <h6 className="info-heading">The full set of services around <br /> development and maintenance <br /> of complex business-critical applications.</h6>
                                                    ...
                                                    <a href="#" className="projects-wrap style-01 wow move-up">
                                                        <div className="projects-image-box">
                                                            ...
                                                            <div className="content">
                                                                ...
                                                                <div className="text">At BITS, we have a holistic and integrated approach towards core modernization to experience technological evolution.
                                                                </div>
                                                                <div className="box-projects-arrow">
                                ...
                                <div className="row align-items-center">
                                    <div className="col-lg-6">
                                        <div className="section-title section-space--pt_60">
                                            ...
                                            <h3 className="text-white"><span className="text-color-secondary">BITS</span> – Top Software
                                    ...
                                    <div className="col-lg-6">
                                        <div className="banner-image section-space--pt_60">
                                            <img src="images/banners/soft-s5-img.webp" className="img-fluid" alt="Image" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div className="single-blog-item blog-grid">
                                            ...
                                            <div className="post-info lg-blog-post-info">
                                                ...
                                                <div className="btn-text">
                                                    <a href="#">Read more <i className="ml-1 button-icon fas fa-arrow-right" /></a>
                                                </div>
                                            </div>
                                            {/* Post info End */}
                                        </div>
